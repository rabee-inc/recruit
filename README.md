...
ようこそ！  
このリポジトリは、**Rabeeのカルチャー・働き方・雇用条件・キャリアパス** などをまとめたドキュメント集です。  
採用候補者の方が「カジュアル面談のように」Rabeeについて深く知ることができるよう整理しています。  

---

## 📌 Rabeeについて
- [会社概要](about/Company overview)
...
## 📖 ドキュメント利用ガイド
- [日本語スタイルガイド](guides/style-guide.md)  
- [Rabee用語集](guides/glossary.md)  
- [カジュアル面談風のQ&Aサンプル](samples/casual-faq.md)  

---

## 🔎 使い方
このリポジトリは以下の目的で活用いただけます。
1. **Rabeeを理解する**  
   カルチャーや働き方を鮮明にイメージできます。  
2. **候補者の疑問に答える**  
   deepwikiを使って質問することで、まるで社員と話しているように情報を得られます。  
3. **入社後のギャップをなくす**  
   具体的なキャリアパスや制度を事前に確認できます。  

---

## 📬 お問い合わせ
採用に関するお問い合わせはこちらまでどうぞ：  
📧 recruit@rabee.jp  
